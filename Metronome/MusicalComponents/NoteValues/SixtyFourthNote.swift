...
struct SixtyFourthNote: MusicalComponent, View {
    let width: CGFloat?
    let height: CGFloat?
...
struct SixtyFourthNote_Previews: PreviewProvider {
    static var previews: some View {
        SixtyFourthNote(relativeHeight: 100)
    }
}
